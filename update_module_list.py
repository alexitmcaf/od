...
if __name__ == '__main__':
    ...
    try:
        ...
        odoo.tools.config['db_host'] = os.getenv('DB_HOST', 'db')  # Default to 'db' for Docker
        odoo.tools.config['db_port'] = os.getenv('DB_PORT', '5432')
        odoo.tools.config['db_user'] = os.getenv('DB_USER', 'odoo')
        odoo.tools.config['db_password'] = os.getenv('DB_PASSWORD', 'odoo16@2022')
